...
const movies = (typeof cinemaData !== 'undefined')
...
function listenToVoteRates() {
    ...
    // ✅ 수정: 시즌 미분리 경로(`votes/categories/${awardName}`) → getVotesCategoryPath()로 통일
    const categoryRef = window.fbRef(window.fbDB, window.getVotesCategoryPath(cinemaState.awardName));
