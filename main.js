...
const categories = [
    ...
    { title: "아트 부문", themes: ['in_between', 'key_animation','directing'], ratio: 'ratio-poster' },
...
function createAwardCard(award, results, ratioClass) {
    ...
    let displayThumb = award.thumb || `AnimeAwards/image/trophy.png`;
    ...
    const mediaTag = isVideo 
        ...
        : `<img src="${displayThumb}" class="award-thumb" onerror="this.src='AnimeAwards/image/trophy.png'">`;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if(submitNewAwardBtn) {
        submitNewAwardBtn.onclick = () => {
            ...
            Awards.push({ name: title, theme: theme, thumb: 'AnimeAwards/image/trophy.png' });
